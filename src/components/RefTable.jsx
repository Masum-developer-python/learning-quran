    ...
    <div id="refTable" className="w-[99%]">
      <table className="text-2xl table-auto border-collapse">
        <caption className="text-left font-bangla bg-white text-green-400 sticky top-0">
          <marquee>
            সুরা, আয়াত বা শব্দের অডিও শুনতে সংখ্যাগুলোর উপর ক্লিক করুন
          </marquee>
        </caption>
        <thead>
          <tr className="sticky top-8 bg-green-100">
            <th className="border-2 font-bangla border-gray-500 p-4">ক্রমিক</th>
            <th className="border-2 font-bangla border-gray-500 p-4">সুরা</th>
            <th className="border-2 font-bangla border-gray-500 p-4">আয়াত</th>
            <th className="border-2 font-bangla border-gray-500 p-4">স্থান</th>
            <th className="border-2 font-bangla border-gray-500 p-4">শব্দ</th>
            <th className="border-2 font-bangla border-gray-500 p-4">
              রেফারেন্স
            </th>
            <th className="border-2 font-bangla border-gray-500 p-4 w-[950px]">
              পূর্ণাঙ্গ আয়াত
            </th>
          </tr>
        </thead>
          ...
          {refData.map((item, index) => (
            <tr key={`${index}trow`} className="h-[90px]">
              ...
              <td
                ...
                className=" border-2 border-gray-500 w-[950px] p-2 text-5xl font-akber"
              >
                {visible[`${item.sura}-${item.aya}-${item.position}`] &&
