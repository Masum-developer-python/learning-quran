...
function Cards({
  ...
  return (
    <>
      <div key={rowIndex} className="flex flex-wrap w-[100%] space-x-1 m-1 ">
        <div
          className={`font-bangla flex  justify-center items-center  text-center text-2xl w-[100%] m-2 max-h-[40px] ${selectedColor.backgroundColor} ${selectedColor.textColor}`}
        >
        ...
        <div className="flex flex-0 flex-wrap flex-row-reverse w-full my-auto md:m-2">
          {arabicAlphabet
              ...
              >
                ...
                >
                  <div
                    ...
                    className={`rtl p-1 py-2 m-auto my-2 w-[150px] md:w-64 h-auto
                    ...
                    {withHoverChildren && (
                      <>
                        <div
                          ...
                          className="text-5xl text-right md:opacity-0 group-hover:opacity-100"
                        >
                          {item.alphabet_name}
                        </div>
                        <div
                          key={`itemName-${rowIndex}-${itemIndex}`}
                          className="text-2xl text-left md:opacity-0 group-hover:opacity-100"
                        >
